    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <ListItem disablePadding sx={{ display: 'block' }} onClick={()=>{navigate("/")}}>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}onClick={()=>{navigate("/recruitment")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
              ...
              >
                ...
                <ListItemText primary="Recruitment" sx={{ opacity: open ? 1 : 0 }} />
              </ListItemButton>
            </ListItem>
            ...
            <ListItem disablePadding sx={{ display: 'block' }}onClick={()=>{navigate("/attendance")}}>
              <ListItemButton
                sx={{
                  minHeight: 48,
                  justifyContent: open ? 'initial' : 'center',
